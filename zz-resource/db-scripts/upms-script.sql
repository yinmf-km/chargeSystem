...
-- 菜单和权限关系表
-- ----------------------------
DROP TABLE IF EXISTS `sys_menu_perm_code`;
CREATE TABLE `sys_menu_perm_code` (
...
-- 系统权限字和权限资源关联表
-- ----------------------------
DROP TABLE IF EXISTS `sys_perm_code_perm`;
CREATE TABLE `sys_perm_code_perm` (
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` VALUES(1627840812937121794,NULL,'公司总部',1,1627840812899373056,CURDATE(),1627840812899373056,CURDATE(),1);
INSERT INTO `sys_user` VALUES(1627840812899373056,'admin','$2a$10$B4rIXdw6II/MAfxKiHxn2uOJIQVFYaj.ZgqCuONJdktlYWS5whSgG','管理员',1627840812937121794,NULL,0,0,NULL,NULL,1627840812899373056,CURDATE(),1627840812899373056,CURDATE(),1);
INSERT INTO `sys_dept_relation` VALUES(1627840812937121794,1627840812937121794);
COMMIT;
