...
public enum ErrorCodeEnum {
     ...
     * 未处理的异常！
     */
    UNHANDLED_EXCEPTION("未处理的异常！"), ARGUMENT_NULL_EXIST("数据验证失败，接口调用参数存在空值，请核对！"),
    ...
    UPLOAD_FAILED("数据验证失败，数据上传失败！"), INVALID_UPLOAD_FIELD("数据验证失败，该字段不支持数据上传！"),
    PARAM_VALID_NULL("请求参数%s不能为空"), INVALID_UPLOAD_STORE_TYPE("数据验证失败，并不支持上传存储类型！"),
    INVALID_UPLOAD_FILE_ARGUMENT("数据验证失败，上传文件参数错误，请核对！"), INVALID_UPLOAD_FILE_FORMAT("无效的上传文件格式！"),
    INVALID_UPLOAD_FILE_IOERROR("上传文件写入失败，请联系管理员！"), UNAUTHORIZED_LOGIN("当前用户尚未登录或登录已超时，请重新登录！"),
    ...
    HAS_CHILDREN_DATA("数据验证失败，子数据存在，请刷新后重试！"), DATA_VALIDATED_FAILED("数据验证失败，请核对！"),
    UPLOAD_FILE_FAILED("文件上传失败，请联系管理员！"), DATA_SAVE_FAILED("数据保存失败，请联系管理员！"),
    DATA_ACCESS_FAILED("数据访问失败，请联系管理员！"), DATA_PERM_ACCESS_FAILED("数据访问失败，您没有该页面的数据访问权限！"),
    ...
    INVALID_DATA_FIELD("数据验证失败，无效的数据实体对象字段！"), INVALID_CLASS_FIELD("数据验证失败，无效的类对象字段！"),
    SERVER_INTERNAL_ERROR("服务器内部错误，请联系管理员！"), REDIS_CACHE_ACCESS_TIMEOUT("Redis缓存数据访问超时，请刷新后重试！"),
