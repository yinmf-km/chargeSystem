package com.course.app.common.core.base.service;
...
import com.course.app.common.core.constant.AggregationType;
import com.course.app.common.core.constant.GlobalDeletedFlag;
import com.course.app.common.core.constant.MaskFieldTypeEnum;
...
public abstract class BaseService<M, K extends Serializable> extends ServiceImpl<BaseDaoMapper<M>, M> implements IBaseService<M, K> {
    ...
    public void updateBatchOneToManyRelation(
        ...
        for (M updateData : updateDataList) {
            ...
            UpdateWrapper<M> uw = this.createUpdateQueryForNullValue(updateData, id);
    ...
    public <R> CallResult verifyImportForDict(List<M> dataList, String fieldName, Function<M, R> idGetter) {
        ...
        BaseService<Object, Serializable> service = ApplicationContextHolder.getBean(
                StrUtil.lowerFirst(relationDict.slaveServiceName()));
    ...
    public <R> CallResult verifyImportForOneToOneRelation(List<M> dataList, String fieldName, Function<M, R> idGetter) {
        ...
        if (CollUtil.isNotEmpty(idSet)) {
            BaseService<Object, Serializable> slaveService = ApplicationContextHolder.getBean(
                    StrUtil.lowerFirst(relationOneToOne.slaveServiceName()));
    ...
    private void initializeRelationStruct(Field f) {
        ...
        if (relationOneToOne != null) {
            ...
            if (StrUtil.isNotBlank(relationOneToOne.slaveServiceName())) {
        ...
        if (relationOneToMany != null) {
            ...
            if (StrUtil.isNotBlank(relationOneToMany.slaveServiceName())) {
                relationStruct.service = ApplicationContextHolder.getBean(
                        StrUtil.lowerFirst(relationOneToMany.slaveServiceName()));
            } else {
                relationStruct.service = (BaseService<Object, Serializable>)
        ...
        if (relationManyToMany != null) {
            ...
            relationStruct.manyToManyMapper = ApplicationContextHolder.getBean(
                    StrUtil.lowerFirst(relationManyToMany.relationMapperName()));
    ...
    private void initializeRelationAggregationStruct(Field f) {
        ...
        if (relationOneToManyAggregation != null) {
            ...
            if (StrUtil.isNotBlank(relationOneToManyAggregation.slaveServiceName())) {
                relationStruct.service = ApplicationContextHolder.getBean(
                        StrUtil.lowerFirst(relationOneToManyAggregation.slaveServiceName()));
            } else {
                relationStruct.service = (BaseService<Object, Serializable>)
        ...
        if (relationManyToManyAggregation != null) {
            ...
            if (StrUtil.isNotBlank(relationManyToManyAggregation.slaveServiceName())) {
                relationStruct.service = ApplicationContextHolder.getBean(
                        StrUtil.lowerFirst(relationManyToManyAggregation.slaveServiceName()));
            } else {
                relationStruct.service = (BaseService<Object, Serializable>)
    ...
    private void initializeRelationDictStruct(Field f) {
        ...
        if (relationDict != null) {
            ...
            if (StrUtil.isNotBlank(relationDict.slaveServiceName())) {
                relationStruct.service = ApplicationContextHolder.getBean(
                        StrUtil.lowerFirst(relationDict.slaveServiceName()));
            } else {
                relationStruct.service = (BaseService<Object, Serializable>)
