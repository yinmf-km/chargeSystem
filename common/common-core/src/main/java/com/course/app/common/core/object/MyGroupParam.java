...
import com.course.app.common.core.config.CoreProperties;
import com.course.app.common.core.constant.ApplicationConstant;
import com.course.app.common.core.exception.InvalidClassFieldException;
import com.course.app.common.core.exception.InvalidDataFieldException;
import com.course.app.common.core.exception.InvalidDataModelException;
...
public class MyGroupParam extends ArrayList<MyGroupParam.GroupInfo> {
    ...
    private void processGroupInfo(
        ...
        } else if (coreProperties.isOracle()) {
