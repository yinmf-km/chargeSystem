...
import com.course.app.common.core.constant.AppDeviceType;
...
public class MyCommonUtil {
     ...
     * @param source 源对象。
     * @param others 其他对象。
     * @return 等于全部对象值返回true，否则false。
     */
    public static boolean equalsAll(Object source, Object...others) {
        for (Object one : others) {
            if (ObjectUtil.notEqual(source, one)) {
                return false;
            }
        }
        return true;
