...
import com.course.app.common.flow.dto.FlowTaskCommentDto;
import com.course.app.common.flow.dto.FlowWorkOrderDto;
import com.course.app.common.flow.model.FlowEntry;
import com.course.app.common.flow.model.FlowEntryPublish;
    ...
    public void buildWorkOrderApprovalStatus(String processDefinitionKey, List<FlowWorkOrderVo> workOrderVoList) {
        ...
        for (FlowWorkOrderVo workOrderVo : workOrderVoList) {
            if (workOrderVo.getLatestApprovalStatus() != null) {
                ...
                if (name != null) {
                    Map<String, Object> lastestApprovalStatusDictMap = new HashMap<>();
