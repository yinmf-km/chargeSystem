...
import com.course.app.webadmin.upms.model.pmms.request.MPNG210002RequestV1;
...
public class MPNG210002V1Test {
	...
	public static void main(String[] args) {
		try {
			...
			MPNG210002RequestV1 request = new MPNG210002RequestV1();
			request.setServiceUrl(APIGW_URL_ADDRESS + "/api/pmssMpng/MPNG210002/v1");
			MPNG210002RequestV1.MPNG210002RequestV1Biz bizContent = new MPNG210002RequestV1.MPNG210002RequestV1Biz();
			ReqHead reqHead = new ReqHead();
			bizContent.setReqHead(reqHead);
			reqHead.setTransTime("20210316143002");
			reqHead.setVersion("V-1.0	");
			MPNG210002RequestV1.MPNG210002RequestV1Biz.ReqBody reqBody = new MPNG210002RequestV1.MPNG210002RequestV1Biz.ReqBody();
			bizContent.setReqBody(reqBody);
			reqBody.setValidPeriod("20210316143200");
			reqBody.setLatitude("1");
			reqBody.setScanCodeText("1258643354165444");
			reqBody.setTerminalInfo("00000001");
			reqBody.setPartnerId("1359663251125");
			...
			reqBody.setTermBatchNo("000123");
			reqBody.setTranScene("B2C-API-SCANCODE");
			reqBody.setIp("182.119.117.128");
			...
			value.setReverse4("1");
			value.setReverse5("1");
			reqBody.setMerPtcId("301310063009501");
			...
			reqBody.setMerTradeTime("123652");
			reqBody.setTermPosNo("000757");
			reqBody.setMerTradeDate("20210316");
			reqBody.setShopId("19000002");
			reqBody.setPayMerTranNo("12185644621782145186");
			reqBody.setTotalAmount("100.00");
			reqBody.setLocation("ONLINE");
			reqBody.setDetail("商品：尺寸");
			reqBody.setTranContent("交易内容：");
			request.setBizContent(bizContent);
			MPNG210002ResponseV1 response = client.execute(request, UUID.randomUUID().toString().replace("-", "1"));
