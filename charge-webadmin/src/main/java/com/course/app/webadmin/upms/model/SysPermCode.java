...
public class SysPermCode extends BaseModel {
    ...
    public interface SysPermCodeModelMapper extends BaseModelMapper<SysPermCodeVo, SysPermCode> {
         ...
         * @return 实体对象。
         */
        @Mapping(target = "sysPermCodePermList", expression = "java(mapToBean(sysPermCodeVo.getSysPermCodePermList(), com.course.app.webadmin.upms.model.SysPermCodePerm.class))")
        @Override
