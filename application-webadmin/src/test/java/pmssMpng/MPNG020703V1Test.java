...
import com.course.app.webadmin.upms.model.pmms.request.MPNG020703RequestV1.MPNG020703RequestV1Biz.*;
...
public class MPNG020703V1Test {
	...
	public static void main(String[] args) {
		try {
			...
			reqHead.setTransTime("20210317150502");
			...
			reqBody.setRefundMerTranNo("12185644621782145186");
			reqBody.setMerPtcId("131058140000089");
			reqBody.setMerRefundDate("20201215");
