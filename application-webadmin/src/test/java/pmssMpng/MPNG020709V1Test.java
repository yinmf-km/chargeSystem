...
import com.course.app.webadmin.upms.model.pmms.request.MPNG020709RequestV1;
...
public class MPNG020709V1Test {
	...
	public static void main(String[] args) {
		try {
			...
			MPNG020709RequestV1 request = new MPNG020709RequestV1();
			request.setServiceUrl(APIGW_URL_ADDRESS + "/api/pmssMpng/MPNG020709/v1");
			MPNG020709RequestV1.MPNG020709RequestV1Biz bizContent = new MPNG020709RequestV1.MPNG020709RequestV1Biz();
			ReqHead reqHead = new ReqHead();
			bizContent.setReqHead(reqHead);
			reqHead.setTransTime("1");
			reqHead.setVersion("1");
			MPNG020709RequestV1.MPNG020709RequestV1Biz.ReqBody reqBody = new MPNG020709RequestV1.MPNG020709RequestV1Biz.ReqBody();
			...
			MPNG020709ResponseV1 response = client.execute(request, UUID.randomUUID().toString().replace("-", "1"));
