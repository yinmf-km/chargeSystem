...
public class MPNG020701V1Test {
	...
	public static void main(String[] args) {
		try {
			...
			reqHead.setTransTime("20211221171611");
			reqHead.setVersion("1.0");
			ReqBody reqBody = new ReqBody();
			bizContent.setReqBody(reqBody);
			reqBody.setAmount("5");
			reqBody.setTranScene("B2C-API-SCANCODE");
			reqBody.setMerPtcId("131058140006003");
			reqBody.setNotifyUrl("");
			reqBody.setMerTradeDate("20211221");
			reqBody.setShopId("");
			reqBody.setPartnerId("");
			reqBody.setPayMerTranNo("MZYJ_25_29_8");
			reqBody.setMerMemo("退款测试");
			reqBody.setRefundMerTranNo("G2021123300849099");
			reqBody.setCurrency("CNY");
			reqBody.setMerRefundTime("171711");
			reqBody.setMerRefundDate("20211221");
