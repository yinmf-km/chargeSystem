...
public class MPNG210003V1Test {
    ...
    public static void main(String[] args) {
        try {
            ...
            MPNG210003RequestV1.MPNG210003RequestV1Biz bizContent =
                new MPNG210003RequestV1.MPNG210003RequestV1Biz();
            ReqHead reqHead = new ReqHead();
            bizContent.setReqHead(reqHead);
            reqHead.setTransTime("20230512160211");
            ...
            reqBody.setMerTradeTime("152411");
            reqBody.setNotifyUrl("http://192.168.23.132");
            reqBody.setMerTradeDate("20210311");
            // reqBody.setShopId("");
            // reqBody.setPartnerId("");
            reqBody.setPayMerTranNo("1218564453277782146687");
            // reqBody.setJumpUrl("");
            ...
            MPNG210003ResponseV1 response =
                client.execute(request, UUID.randomUUID().toString().replace("-", ""));
