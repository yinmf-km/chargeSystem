...
import com.course.app.webadmin.upms.model.pmms.request.MPNG210003RequestV1.MPNG210003RequestV1Biz.*;
...
public class MPNG210003V1Test {
	...
	public static void main(String[] args) {
		try {
			...
			reqHead.setTransTime("20220311153011");
			...
			reqBody.setMerPtcId("131007420005883");
